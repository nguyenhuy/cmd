...
struct AttachmentsView: View {
  ...
  @State var previewedAttachment: Attachment?
  ...
  private func preview(attachment: Attachment) {
  ...
  private func remove(attachment: Attachment) {
...
#Preview {
  VStack {
    AttachmentsView(attachments: Binding<[Attachment]>.constant([.fileSelection(.init(
