...
typealias SearchFilesStatus = SearchFilesTool.SearchFilesToolUse.Status
...
#Preview {
  ScrollView {
    VStack(alignment: .leading, spacing: 10) {
      ...
      ToolUseView(toolUse: ToolUseViewModel(
        status: SearchFilesStatus.Just(.completed(.success(SearchFilesTool.SearchFilesToolUse.Output(
          outputForLLm: "...",
          results: [
