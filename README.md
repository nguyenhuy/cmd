...
<ul>
    <li><a href="https://github.com/getcmd-dev/cmd/releases/download/v0.1.18/cmd.dmg">Download the latest release</a></li><!-- version automatically updated during release -->
