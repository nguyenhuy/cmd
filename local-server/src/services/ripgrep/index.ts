// Copied from https://github.com/RooVetGit/Roo-Code/blob/9fadd3dbe20011cde2c3a6e1d9cacb479296129e
...
import {
	SearchFileResult as SearchFileResultSchema,
	SearchFilesToolOutput,
} from "../../server/schemas/searchFileSchema"
...
export const rgPath = path.join(__dirname, "./", "rg-14.1.1")
